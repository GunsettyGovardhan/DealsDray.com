...
public class EdgeLink3 {
	...
	public static void main(String[] args) throws Exception {
        ...
        Files.copy(file, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\EDge\\09-5.png"));
        Thread.sleep(4000); 
        Dimension cap1 = new Dimension(1536,864);
        driver.manage().window().setSize(cap1);
        Thread.sleep(4000); 
        File file1=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        Files.copy(file1, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\Edge\\09-5_10.png"));
        Thread.sleep(4000); 
        Dimension cap2 = new Dimension(1366,768);
        driver.manage().window().setSize(cap2);
        Thread.sleep(4000); 
        File file2=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        Files.copy(file2, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\Edge\\09-5_20.png"));
        Thread.sleep(4000); 
        ...
        Files.copy(file3, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\Edge\\09-5_30.png"));
        Thread.sleep(4000); 
        ...
        Files.copy(file4, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\Edge\\09-5_40.png"));
        Thread.sleep(4000); 
        ...
        Files.copy(file5, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Dealsdray\\Edge\\09-5_50.png"));
        driver.quit();
	}
